...
manhattan_state <- function() HaDeX_plotSettingsSection(
  ...
  splitLayout(selectInput_h(inputId = "mann_state_1",
                            label = "State 1",
                            choices = c("CD160", "CD160_HVEM")),
              selectInput_h(inputId = "mann_state_2",
                            label = "State 2",
...
manhattan_test <- function() HaDeX_plotSettingsSection(
  ...
  selectInput_h(inputId = "mann_confidence_level",
                label = "Confidence level:",
                choices = c("20%" = 0.2, "50%" = 0.5, "80%" = 0.8, "90%" = 0.9, "95%" = 0.95, "98%" = 0.98, "99%" = 0.99, "99.9%" = 0.999),
                selected = 0.98),
  selectInput_h(inputId = "mann_p_adjustment_method",
