                ...
                tags$div(
                  ...
                  tabsetPanel(type = "pills",
                              tabPanel("Start",
                                       ...
                                       h4("If you wish to contact us, feel free to write tu us: hadex@ibb.waw.pl"), 
                                       ...
                                       fluidRow(
                                         column(2, 
                                                ...
                                                selectInput_h(inputId = "chosen_control",
                                                              label = "Choose control for chosen protein: ",
                              ...
                              tabPanel("Woods plot",
                                       ...
                                       sidebarPanel(
                                         ...
                                         fluidRow(column(3, checkboxInput_h(inputId = "theory",
                                         ...
                                         fluidRow(
                                           ...
                                           column(6,
                                                  helper(tags$button("Adjust colors",
                                                              ...
                                                              `data-toggle`="collapse",
                                                              `data-target`="#colorss"),
                                                         content = "theory", type = "markdown", buttonLabel = "Okay", easyClose = TRUE),
                                                  tags$div(
                                                    class = "hideable",
                                                    id = "colorss",
