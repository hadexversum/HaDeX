                                         ...
                                         tabPanel("Chiclet differential plot",
                                                  ...
                                                  sidebarPanel(
                                                    ...
                                                    splitLayout(selectInput_h(inputId = "chic_diff_state_first",
                                                                              label = "State 1",
                                                                              choices = c("CD160", "CD160_HVEM")),
                                                                selectInput_h(inputId = "chic_diff_state_second",
                                                                              label = "State 2",
                                                                              choices = c("CD160_HVEM", "CD160"))
                                                    ),
                                                    fluidRow(
                                                      column(width = 6,
                                                             checkboxGroupInput_h(inputId = "chic_diff_timepoints",
                                                                                  ...
                                                                                  selected = c(0.167, 1, 5, 25, 120, 1440)),
                                                             h4("Visualization:"),
                                                             checkboxInput_h(inputId = "chic_diff_uncertainty",
                                                                             label = "Show uncertainty",
                                                                             value = FALSE)
                                                      ),
                                                      column(width = 6,
                                                             ...
                                                             div(id = "chicdiff_time_100_part",
                                                                 selectInput_h(inputId = "chicdiff_time_100",
                                                                               label = "TIME OUT",
                                                                               choices = c(0, 0.001, 1, 5, 25, 1440),
                                                                               selected = 1440)
                                                             )
                                                    ...
                                                    sliderInput(inputId = "chic_diff_x_range",
                                                                ...
                                                                value = c(1, 41),
                                                                step = 1),
                                                    sliderInput(inputId = "chic_diff_y_range",
                                                                label = "Choose y range for chiclet plot:",
                                                                min = -2,
                                                                max = 2,
                                                                value = c(-2, 2),
                                                                step = 1),
