                                       ...
                                       fluidRow(
                                         ...
                                         column(3,
                                                hidden(div(id = "examiner_settings",
                                                    ...
                                                    h4("Some of the information from the datafile requires your confirmation."),
                                                    h4("For the addtional information how the data from HDeXaminer is processed, check the requirements above. Keep in mind that the MHP value is genereted based on the peptide sequence and therefore may differ from actual value in case of the modifications. The values with low confidence flag, are not taken into account."),
