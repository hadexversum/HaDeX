                  ...
                  tabsetPanel(type = "pills",
                              ...
                              tabPanel("Woods plot",
                                       ...
                                       sidebarPanel(
                                         ...
                                         selectInput(inputId = "chosen_protein_woods",
                              ...
                              tabPanel("Coverage", 
                                       ...
                                       sidebarPanel(
                                         class = "scrollable",
                                         selectInput(inputId = "chosen_protein_cov",
                                                     label = "Choose protein: ",
                                                     choices = c("db_CD160")),
                                         radioButtons(
                              ...
                              tabPanel("Sequence data",
                                       h3('Protein name'),
                                       selectInput(inputId = "chosen_protein_seq",
                                                   label = "Choose protein: ",
                                                   choices = c("db_CD160")),
                              ...
                              tabPanel("Kinetics",
                                       ...
                                       sidebarPanel(
                                         ...
                                         radioButtons(inputId = "kin_calc_type",
                                                      ...
                                                      choices = c("relative", "absolute"),
                                                      selected = "relative"),
                                         selectInput(inputId = "chosen_protein_kin",
                                                     label = "Choose protein: ",
                                                     choices = c("db_CD160")),
                                         h5("Choose time parameters:"),
                                         splitLayout(
