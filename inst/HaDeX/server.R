...
server <- function(input, output, session) {
  ...
  dat_new <- reactive({
    ...
    dat() %>%
      ...
      select(Sequence, Start, End, Med_Sequence, frac_exch_state_1, err_frac_exch_state_1, frac_exch_state_2, err_frac_exch_state_2, diff_frac_exch, err_frac_exch, diff_theo_frac_exch, err_diff_theo_frac_exch, avg_theo_in_time_first, avg_theo_in_time_second, err_avg_theo_in_time_first, err_avg_theo_in_time_second) %>%
      arrange(Start, End)
