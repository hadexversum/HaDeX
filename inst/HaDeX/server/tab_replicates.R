...
replicate_plot_out <- reactive({
  ...
  plot_peptide_mass_measurement(dat(),
                                ...
                                show_charge_values = input[["rep_show_charge"]],
                                state =  input[["rep_state"]],
    ...
    theme(plot.title = element_text(size = input[["rep_plot_title_size"]]),
          ...
          legend.text = element_text(size = input[["rep_plot_x_label_size"]]),
          legend.title = element_text(size = input[["rep_plot_x_label_size"]]))
