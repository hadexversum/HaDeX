...
```{r message=FALSE}
plot_differential_butterfly(diff_uptake_dat, fractional = TRUE, show_confidence_limit = TRUE) +
...
```{r}
plot_chiclet(uptake_dat, show_uncertainty = T, fractional = TRUE)
```
...
```{r}
plot_differential_chiclet(diff_uptake_dat, show_uncertainty = TRUE, fractional = TRUE)
```
