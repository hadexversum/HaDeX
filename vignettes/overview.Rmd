...
$$u_{c}(y) = \sqrt{\sum_{k} \bigg[ \frac{\partial y}{\partial x_{k}} u(x_{k}) \bigg]^2}\tag{1}$$
...
For differential plot in Woods format, deueration level in one state $(D_{2})$ is simply subtracted from deuteration level in other state $(D_{1})$:
