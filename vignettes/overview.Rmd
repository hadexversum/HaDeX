...
**Coverage and peptide overlap:** overview of experimental squence coverage is available in user-friendly way.
...
**Report generation:** generates raport (e.q. in html format) with results of analysis with parametrization.
