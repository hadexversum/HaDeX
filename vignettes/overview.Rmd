...
author: "Weronika Pucha&#322;a, Micha&#322; Burdukiewicz, Micha&#322; Kistowski, Katarzyna A. Dabrowska, Aleksandra E. Badaczewska-Dawid, Dominik Cysewski, Micha&#322; Dadlez"
date: "15.02.2019"
output: 
...
Example above is based on relative values. Although HaDeX provides results in absolute values, be aware that absolute calculations don't 
contain time out (it is used for scaling), so the uncertainty is not the function of $D_{100}$ - it is constant. 
