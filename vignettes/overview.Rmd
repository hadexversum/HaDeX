...
$$u_{c}(D) = \sqrt{ \left[ \frac{1}{D_{100}-D_{t_0}} u(D_{t}) \right]^2 + \left[ \frac{D_{t} - D_{100}}{D_{t_{out}-D_{t_0})^2} u(D_{t_0}) \right]^2 + \left[ \frac{D_{t_0} - D_{t}}{D_{t_{out}-D_{t_0})^2} uD_{t_{out}) \right]^2}\tag{7}$$
...
- $D_{t}$ - deuteration measured in a chosen time point,

- $MHP$ - theoretical mass of the peptide (constant),

- $MaxUptake$ - the maximum proton uptake for the peptide (theoretical constant),
...
and substituting $D$ from the equation 8:
