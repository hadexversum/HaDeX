...
What we see on comparison plots?

Comparison plots show the peptides’ level of deuteration.
The x axis shows amino acid position in protein sequence, the y axis shows the level of exchange- relative (in percent) or absolute (in Da).
For example, the plot below shows levels of peptides’ deuteration after 1 minute deuteration time along with error bars.
