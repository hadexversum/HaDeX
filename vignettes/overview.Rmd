...
comparison_plot(calc_dat = calc_dat,
  ...
  labs(plot_title = "Theoretical fraction exchanged in \nstate comparison in 25 min time")
```
...
comparison_plot(calc_dat = calc_dat,
                ...
                state_first = "Nucb2 Factor 1",
                state_second = "Nucb2 Factor 2") +
  labs(plot_title = "Fraction exchanged in state comparison \nin 25 min time")
```
...
woods_plot(calc_dat = calc_dat,
           theoretical = TRUE) +
  labs(plot_title = "Theoretical fraction exchanged between \nstates in 25 min time")
```
...
comparison_plot(calc_dat = calc_dat_2,
                ...
                state_first = "Nucb2 Factor 1",
                state_second = "Nucb2 Factor 2") +
  labs(plot_title = "Fraction exchanged in \nstate comparison in 25 min time")
...
woods_plot(calc_dat = calc_dat_2,
           theoretical = FALSE) +
  labs(plot_title = "Fraction exchanged between \nstates in 25 min time")
