...
- $aggMass$ - weighted mean mass of the peptide,
...
Input files always encompass results of more than one measurement. The mean mass $aggMass$ for each time point of the measurement in each state is treated as an individual result. This means that the peptide mass uncertainty $u$ is calculated using the formula for standard deviation of the mean:
...
$$D = \frac{D_{t} - D_{0}}{D_{t_{out}} - D_{t_0}}\tag{4a}$$
