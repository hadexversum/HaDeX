...
We can use these type of chart to preliminary inspect data.
...
Next, on the the Woods we see peptides with the decreased hydrogen-deuterium exchange after the binding with the other protein.

The theoretical values are commonly used in situations where we do not have measured the endopoint of the exchange (low amount of material, exchange occurs very slowly)
