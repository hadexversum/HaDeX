...
The HaDeX web server works only on data in the DynamX™ datafile format (as produced by DynamX™ 3.0 software by Waters). It must contains a following set of columns with specified properties:
