...
test_that("Theo Frac show_uptake_data colnames",
          expect_equal(colnames(show_uptake_data(uptake_dat,
                                                 theoretical = T,
                                                 fractional = T)),
                       c("Protein", "Sequence", "ID", "State", "Start", "End", "Exposure", "Theo Frac DU [%]", "Err Theo Frac DU [%]")
          )
)
...
test_that("Frac show_uptake_data colnames",
          expect_equal(colnames(show_uptake_data(uptake_dat,
                                                 theoretical = F,
                                                 fractional = T)),
                       c("Protein", "Sequence", "ID", "State", "Start", "End", "Exposure", "Frac DU [%]", "Err Frac DU [%]")
          )
)
...
test_that("Theo show_uptake_data colnames",
          expect_equal(colnames(show_uptake_data(uptake_dat,
                                                 theoretical = T,
                                                 fractional = F)),
                       c("Protein", "Sequence", "ID", "State", "Start", "End", "Exposure", "Theo DU [Da]", "Err Theo DU [Da]")
          )
)
...
test_that("show_uptake_data colnames",
          expect_equal(colnames(show_uptake_data(uptake_dat,
                                                 theoretical = F,
                                                 fractional = F)),
                       c("Protein", "Sequence", "ID", "State", "Start", "End", "Exposure", "DU [Da]", "Err DU [Da]")
          )
)
...
test_that("Theo Frac show_diff_uptake_data colnames",
          expect_equal(colnames(show_diff_uptake_data(diff_uptake_dat,
                                                      theoretical = T,
                                                      fractional = T)),
                       c("Protein", "Sequence", "ID", "Start", "End", "Exposure", "Theo Frac Diff DU [%]", "Err Theo Frac Diff DU [%]")
          )
)
...
test_that("Frac show_diff_uptake_data colnames",
          expect_equal(colnames(show_diff_uptake_data(diff_uptake_dat,
                                                      theoretical = F,
                                                      fractional = T)),
                       c("Protein", "Sequence", "ID", "Start", "End", "Exposure", "Frac Diff DU [%]", "Err Frac Diff DU [%]")
          )
)
...
test_that("Theo show_diff_uptake_data colnames",
          expect_equal(colnames(show_diff_uptake_data(diff_uptake_dat,
                                                      theoretical = T,
                                                      fractional = F)),
                       c("Protein", "Sequence", "ID", "Start", "End", "Exposure", "Theo Diff DU [Da]", "Err Theo Diff DU [Da]")
          )
)
...
test_that("show_diff_uptake_data colnames",
          expect_equal(colnames(show_diff_uptake_data(diff_uptake_dat,
                                                      theoretical = F,
                                                      fractional = F)),
                       c("Protein", "Sequence", "ID", "Start", "End", "Exposure", "Diff DU [Da]", "Err Diff DU [Da]")
          )
)
...
test_that("Theo Frac show_diff_uptake_data_confidence colnames",
          expect_equal(colnames(show_diff_uptake_data_confidence(diff_uptake_dat,
                                                                 theoretical = T,
                                                                 fractional = T)),
                       c("Protein", "Sequence", "ID", "Start", "End", "Exposure", "Theo Frac Diff DU [%]", "Err Theo Frac Diff DU [%]", "Valid At 0.98", "Valid At 0.99")
          )
)
...
test_that("Theo show_diff_uptake_data_confidence colnames",
          expect_equal(colnames(show_diff_uptake_data_confidence(diff_uptake_dat,
                                                                 theoretical = T,
                                                                 fractional = F)),
                       c("Protein", "Sequence", "ID", "Start", "End", "Exposure", "Theo DU [Da]", "Err Theo DU [Da]", "Valid At 0.98", "Valid At 0.99")
          )
)
...
test_that("Frac show_diff_uptake_data_confidence colnames",
          expect_equal(colnames(show_diff_uptake_data_confidence(diff_uptake_dat,
                                                                 theoretical = F,
                                                                 fractional = T)),
                       c("Protein", "Sequence", "ID", "Start", "End", "Exposure", "Frac Diff DU [%]", "Err Frac Diff DU [%]", "Valid At 0.98", "Valid At 0.99")
          )
)
...
test_that("show_diff_uptake_data_confidence colnames",
          expect_equal(colnames(show_diff_uptake_data_confidence(diff_uptake_dat,
                                                                 theoretical = F,
                                                                 fractional = F)),
                       c("Protein", "Sequence", "ID", "Start", "End", "Exposure", "Diff DU [Da]", "Err Diff DU [Da]" , "Valid At 0.98", "Valid At 0.99")
          )
)
